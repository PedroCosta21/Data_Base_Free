...
CREATE TABLE `tb_itens_pedido` (
  `QTD_PEDIDO` int DEFAULT NULL,
  `VALOR_ITEM_PEDIDO` double DEFAULT NULL,
  ...
  CONSTRAINT `fk_itens_pedido_livro` FOREIGN KEY (`COD_LIVRO`) REFERENCES `tb_livro` (`COD_LIVRO`) ON DELETE CASCADE,
  CONSTRAINT `fk_itens_pedido_pedido` FOREIGN KEY (`NUM_PEDIDO`) REFERENCES `tb_pedido` (`NUM_PEDIDO`) ON DELETE CASCADE
